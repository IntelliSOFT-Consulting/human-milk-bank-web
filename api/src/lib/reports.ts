...
export let firstFeeding = async () => {
    ...
    let categories = {withinOne:0, afterOne:0, afterTwo:0, afterThree:0}
    let _map = {withinOne:"Within 1 Hour", afterOne:"After 1 Hour", afterTwo:"After 2 Hours", afterThree:"After 3 Hours"}
    if(observations){
