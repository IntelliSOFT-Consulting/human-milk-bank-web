...
export default function Header({ children }) {
  ...
  return (
    <>
      <AppBar position="fixed" sx={{ color: 'white', backgroundColor: '#37379b' }}>
        <Container maxWidth="xl">
          <Toolbar disableGutters>
            ...
            <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'inline-block' } }}>
              ...
              >
                {pages.map((page) => (
                  <MenuItem key={Object.keys(page)[0]} onClick={handleCloseNavMenu} sx={{ color: "#37379b" }}>
            ...
            </Box> : <Button variant="outlined" onClick={e => { navigate('/login') }} sx={{ color: "#37379b" }}>LOGIN</Button>}
          </Toolbar>
        </Container>
      </AppBar>
      <br /><br /><br />
